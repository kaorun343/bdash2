...
export type UserQueryStatus = 'FAILURE' | 'SUCCESS' | 'WORKING'

export type DataSourceForDataSourceListLayoutFragment = ({ __typename?: 'DataSource' } & {
...
export type DataSourceForDataSourceListFragment = ({ __typename?: 'DataSource'; id: string } & {
...
export type DataSourceForDataSourceListItemFragment = { __typename?: 'DataSource'; id: string; name: string } & {
  ' $fragmentName'?: 'DataSourceForDataSourceListItemFragment'
}
...
export type UserQueryForQueryDetailPageFragment = ({ __typename?: 'UserQuery'; status?: UserQueryStatus | null } & {
...
export type UserQueryForEditorFragment = { __typename?: 'UserQuery'; id: string; title: string; body: string } & {
  ' $fragmentName'?: 'UserQueryForEditorFragment'
}
...
export type UserQueryForQueryListItemFragment = { __typename?: 'UserQuery'; id: string; title: string } & {
  ' $fragmentName'?: 'UserQueryForQueryListItemFragment'
}

export type UserQueryGroupForQueryGroupListLayoutFragment = ({ __typename?: 'UserQueryGroup' } & {
...
export type UserQueryGroupForQueryGroupListFragment = ({ __typename?: 'UserQueryGroup'; id: string } & {
...
export type UserQueryGroupForQueryGroupListItemFragment = {
  __typename?: 'UserQueryGroup'
  id: string
  title: string
} & { ' $fragmentName'?: 'UserQueryGroupForQueryGroupListItemFragment' }
...
export type GetQueryGroupListLayoutQuery = {
  ...
  queryGroups: Array<
    { __typename?: 'UserQueryGroup' } & {
      ' $fragmentRefs'?: {
        UserQueryGroupForQueryGroupListLayoutFragment: UserQueryGroupForQueryGroupListLayoutFragment
      }
    }
  >
}
...
export const DataSourceForDataSourceListItemFragmentDoc = new TypedDocumentString(
  ...
  name
    ...
    `,
  { fragmentName: 'DataSourceForDataSourceListItem' },
) as unknown as TypedDocumentString<DataSourceForDataSourceListItemFragment, unknown>
export const DataSourceForDataSourceListFragmentDoc = new TypedDocumentString(
  ...
  { fragmentName: 'DataSourceForDataSourceList' },
) as unknown as TypedDocumentString<DataSourceForDataSourceListFragment, unknown>
...
fragment DataSourceForDataSourceListItem on DataSource {
  ...
  { fragmentName: 'DataSourceForDataSourceListLayout' },
) as unknown as TypedDocumentString<DataSourceForDataSourceListLayoutFragment, unknown>
export const UserQueryForEditorFragmentDoc = new TypedDocumentString(
  ...
  body
    ...
    `,
  { fragmentName: 'UserQueryForEditor' },
) as unknown as TypedDocumentString<UserQueryForEditorFragment, unknown>
export const UserQueryForQueryDetailPageFragmentDoc = new TypedDocumentString(
  ...
  { fragmentName: 'UserQueryForQueryDetailPage' },
) as unknown as TypedDocumentString<UserQueryForQueryDetailPageFragment, unknown>
export const UserQueryForQueryListItemFragmentDoc = new TypedDocumentString(
  ...
  title
    ...
    `,
  { fragmentName: 'UserQueryForQueryListItem' },
) as unknown as TypedDocumentString<UserQueryForQueryListItemFragment, unknown>
export const UserQueryGroupForQueryGroupListItemFragmentDoc = new TypedDocumentString(
  ...
  title
    ...
    `,
  { fragmentName: 'UserQueryGroupForQueryGroupListItem' },
) as unknown as TypedDocumentString<UserQueryGroupForQueryGroupListItemFragment, unknown>
export const UserQueryGroupForQueryGroupListFragmentDoc = new TypedDocumentString(
  ...
  { fragmentName: 'UserQueryGroupForQueryGroupList' },
) as unknown as TypedDocumentString<UserQueryGroupForQueryGroupListFragment, unknown>
...
fragment UserQueryGroupForQueryGroupListItem on UserQueryGroup {
  ...
  { fragmentName: 'UserQueryGroupForQueryGroupListLayout' },
) as unknown as TypedDocumentString<UserQueryGroupForQueryGroupListLayoutFragment, unknown>
